...
public class Mosque {
	...
	public Mosque(int id, String name, String address, double credit_amount, double debit_amount, String wop,
			String trade_head, String yot, String trade_by, double total_balance) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Mosque [id=" + id + ", name=" + name + ", address=" + address + ", credit_amount=" + credit_amount
				+ ", debit_amount=" + debit_amount + ", wop=" + wop + ", trade_head=" + trade_head + ", yot=" + yot
				+ ", trade_by=" + trade_by + ", total_balance=" + total_balance + "]";
	}
